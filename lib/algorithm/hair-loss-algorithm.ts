...
export class HairLossAlgorithm implements HealthVerticalAlgorithm {
    ...
    mapResponsesToPatientData(responses: Record<string, any>, questions: any[]): PatientData {
        ...
        return {
            ...
            familyHistory: mappedData.familyHistoryHairLoss || '',
            familyHistoryAge: mappedData.familyHistoryHairLossAge,
            ...
            medications: mappedData.currentMedications || '',
            medicationsList: mappedData.currentMedicationList,
            previousTreatments: mappedData.previousHairLossTreatments || '',
            previousTreatmentsDetails: mappedData.previousHairLossTreatmentsDetails,
            treatmentGoals: Array.isArray(mappedData.treatmentGoals) ? mappedData.treatmentGoals : [],
            importance: parseInt(mappedData.importanceScaleRating) || 5,
            commitment: mappedData.sixMonthCommitment || '',
