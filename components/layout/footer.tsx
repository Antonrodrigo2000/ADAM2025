    ...
    <footer className="bg-black text-white py-16">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© 2024 ADAM. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link href="#" className="text-gray-400 hover:text-white transition-colors">
              ...
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path
                  fillRule="evenodd"
                  d="M10 0C4.477 0 0 4.477 0 10s4.477 10 10 10 10-4.477 10-10S15.523 0 10 0zm4.896 4.896a.896.896 0 11-1.792 0 .896.896 0 011.792 0zM10 7.104a2.896 2.896 0 100 5.792 2.896 2.896 0 000-5.792zm0 1.792a1.104 1.104 0 110 2.208 1.104 1.104 0 010-2.208z"
                  clipRule="evenodd"
                />
              </svg>
            </Link>
