export function TrustBadges() {
  const badges = [
    ...
    },
    {
      ...
      description: "Quick response SLA",
    },
  ]

  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-16 p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
