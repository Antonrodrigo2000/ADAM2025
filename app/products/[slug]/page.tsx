...
const products = [
  {
    ...
    description:
      "Clinically proven topical solution for male pattern baldness. Pharmaceutical-grade formula that stimulates hair follicles and promotes regrowth.",
    longDescription:
      "Our pharmaceutical-grade Minoxidil 5% solution is the gold standard for treating male pattern baldness. This topical treatment works by increasing blood flow to hair follicles, extending the growth phase of hair, and gradually increasing follicle size.",
    benefits: [
  ...
  },
  {
    ...
    longDescription:
      "Our premium Hair Growth Combination Spray represents the pinnacle of hair restoration science. This physician-formulated treatment combines three powerful ingredients: Minoxidil 5% for follicle stimulation, Finasteride 0.1% to block DHT production, and proprietary growth peptides to enhance cellular regeneration.",
    benefits: [
